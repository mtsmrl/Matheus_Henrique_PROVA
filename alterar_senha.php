...
if($_SERVER['REQUEST_METHOD']== "POST") {
    ...
    if ($nova_senha !== $confirmar_senha) {
        ...
        echo "<script>alert('Escolha uma senha diferente de temporária!');window.location.href = 'alterar_senha.php';</script>";
        exit();
    } else {
       $senha_hash = password_hash($nova_senha, PASSWORD_DEFAULT);

       // ATUALIZA A SENHA E REMOVE O STATUS DE SENHA TEMPORARIA
